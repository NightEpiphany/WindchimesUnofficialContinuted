...
public class BambooChimeBlockEntity extends BlockEntity {
    ...
    public BambooChimeBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntityReg.BAMBOO, pos, state);
        this.ringingTicks = 0;
    ...
    public static void clientTick(World world, BlockPos pos, BlockState state, BambooChimeBlockEntity blockEntity) {
        tick(world, pos, state, blockEntity);
    }

    public static void serverTick(World world, BlockPos pos, BlockState state, BambooChimeBlockEntity blockEntity) {
        tick(world, pos, state, blockEntity);
    }

    public static void tick(World world, BlockPos pos, BlockState blockState, BambooChimeBlockEntity that) {
        if(world.isClient()) {
